...
x_train <- xgb.DMatrix(as.matrix(train %>%
                                   select(year,half,quarter,month,month.xts,day,mday,qday,yday,mweek,week,week.iso,week2,week3,week4,mday7)))


x_pred <- as.matrix(pred %>% select(year,half,quarter,month,month.xts,day,mday,qday,yday,mweek,week,week.iso,week2,week3,week4,mday7))
